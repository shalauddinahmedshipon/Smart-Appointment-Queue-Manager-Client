  ...
  return (
    <SidebarMenu>
      <SidebarMenuItem>
         ...
         <Link href="/"> 
           <div className="flex items-center gap-2  cursor-pointer rounded-lg hover:bg-sidebar-accent transition-colors">
              
              {/* Force Square Container */}
              <div className="size-9 shrink-0 bg-sidebar-primary flex items-center justify-center overflow-hidden aspect-square">
